...
namespace WCFService
{
    ...
    public partial class AWE : DbContext
    {
        public AWE()
            : base("name=AWE")
        {
        ...
        [DbFunction("AWE", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AWE].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
    
        public virtual ObjectResult<spSelectProcIn_Result> spSelectProcIn()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spSelectProcIn_Result>("spSelectProcIn");
        }
